...
public class Attendance_Approval_Revised_Content_Activity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(type.equalsIgnoreCase("WEEKLYOFF")){
            ...
            FragmentManager fm = getSupportFragmentManager();
            FragmentTransaction fmt = fm.beginTransaction();
            AttendanceApprovalWeeklyOffFragment1 inTime2 = new AttendanceApprovalWeeklyOffFragment1();
        ...
        if(type.equalsIgnoreCase("LEAVE")){
            ...
            FragmentManager fm = getSupportFragmentManager();
            FragmentTransaction fmt = fm.beginTransaction();
            AttendanceApprovalLeaveFragment1 inTime3 = new AttendanceApprovalLeaveFragment1();
        ...
        if(type.equalsIgnoreCase("LWP")){
            ...
            FragmentManager fm = getSupportFragmentManager();
            FragmentTransaction fmt = fm.beginTransaction();
            AttendanceApprovalLWPFragment1 inTime3 = new AttendanceApprovalLWPFragment1();
     ...
     /* if(type.equalsIgnoreCase("HL")){
        ...
        if(type.equalsIgnoreCase("OD")){
            ...
            FragmentManager fm = getSupportFragmentManager();
            FragmentTransaction fmt = fm.beginTransaction();
            AttendanceApprovalMeetingFragment1 inTime4 = new AttendanceApprovalMeetingFragment1();
...
*/
    ...
    private void initAllViews() {
        ...
        //Progress Dialog
        progressDialog = new ProgressDialog(Attendance_Approval_Revised_Content_Activity2.this);
    ...
    {
        Attendance_Approval_Revised_Content_Activity2.this.finish();
