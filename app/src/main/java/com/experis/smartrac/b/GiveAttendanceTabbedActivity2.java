...
public class GiveAttendanceTabbedActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        attendancetopbarusericonImageViewID.setOnClickListener(new ImageView.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent i = new Intent(GiveAttendanceTabbedActivity2.this, ChangePasswordActivity.class);
                startActivity(i);
        ...
        if (CommonUtils.locationServicesEnabled(GiveAttendanceTabbedActivity2.this)) {
        } else {
            ...
            final AlertDialog.Builder aldb = new AlertDialog.Builder(GiveAttendanceTabbedActivity2.this);
    ...
    private void checkAllPermissions() {
        ...
        if (ContextCompat.checkSelfPermission(GiveAttendanceTabbedActivity2.this,
                android.Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(GiveAttendanceTabbedActivity2.this,
                ...
                ActivityCompat.requestPermissions(GiveAttendanceTabbedActivity2.this,
    ...
    private void initAllViews() {
        ...
        //Progress Dialog
        progressDialog = new ProgressDialog(GiveAttendanceTabbedActivity2.this);
    }
    ...
    public void onBackPressed() {
        ...
        GiveAttendanceTabbedActivity2.this.finish();
        overridePendingTransition(R.anim.pull_in_right, R.anim.push_out_left);
    }

    private void clearAllNotification() {
        notificationManager = (NotificationManager) GiveAttendanceTabbedActivity2.this.getSystemService(Context.NOTIFICATION_SERVICE);
